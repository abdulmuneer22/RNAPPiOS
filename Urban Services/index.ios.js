...
const NavigationBarRouteMapper = {
  ...
  Title(route, navigator, index, navState) {
    ...
    switch(route.name){
      ...
      case 'login':
            return <Text 
            style={{fontFamily:'Arial',marginTop : 15,color : 'white',fontSize: 19,fontWeight:'bold',justifyContent : 'center',borderColor:'black',borderWidth: 1}}>
            Login</Text>
      case 'SplashScreen':
            return <Text 
            style={{fontFamily:'Arial',marginTop : 15,color : 'white',fontSize: 19,fontWeight:'bold',justifyContent : 'center',borderColor:'black',borderWidth: 1}}>
      ...
      case 'mainScreen':
            return <Text 
            style={{marginTop : 15,marginLeft : 0,color : 'white',fontSize: 19,fontWeight:'bold',fontFamily:'Arial'}}>
            Urban Services</Text>
      case 'watercan':
            return <Text 
            style={{marginTop : 15,marginLeft : 0,color : 'white',fontSize: 19,fontWeight:'bold',fontFamily:'Arial'}}>
  ...
  <Navigator 
    ...
    navigationBar={
          <Navigator.NavigationBar
            style={{backgroundColor : 'rgb(49, 128, 250)'}}
